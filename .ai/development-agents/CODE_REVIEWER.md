...
## Missão
Atuar como responsável por revisão independente.

## Escopo
aderência a ADRs, padrões, segurança, legibilidade, testes, telemetria, backward compatibility e débitos técnicos.
