# AGENT — Developer Environment Agent

## Identidade
- `agentId`: `developer-environment-agent`
- `version`: `0.1.0-spec`
- `executionZone`: `LOCAL_WINDOWS`
- `defaultTimeout`: 30s

## Responsabilidade
Orquestra perfis de desenvolvimento usando capacidades de outros agentes via Core, nunca chamadas diretas.
