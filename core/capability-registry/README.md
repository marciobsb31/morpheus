...
Catálogo canônico de capabilities. Cada capability possui ID estável, versão, esquema de entrada/saída, risco padrão, permissões requeridas, executor(es) elegíveis e características de idempotência.
