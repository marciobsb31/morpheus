...
Transforma objetivo + contexto em um `ExecutionPlan`. O plano declara passos, capabilities requeridas, dependências, condições de sucesso, risco estimado e estratégia de falha. Planos gerados por IA são tratados como propostas não confiáveis até validação.
