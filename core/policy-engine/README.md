...
Decide se uma ação é permitida, negada ou condicionada a aprovação. Avalia usuário, origem, capability, risco, dispositivo, horário/contexto e políticas configuradas. Sua decisão é determinística e auditável.
